...
import { CloudUpload, Eye, FileUser, Funnel, ListFilter } from "lucide-react";
          ...
          {role === "admin" ||
            (role === "superadmin" && (
              <>
                ...
                <Link
                  href={`/list/employees/upload/${item.id}`}
                  className="w-7 h-7 flex items-center justify-center rounded-full bg-blue-300 hover:bg-blue-500"
                >
                  <CloudUpload size={16} />
                </Link>
              </>
