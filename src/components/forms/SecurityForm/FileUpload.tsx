...
export default function FileUpload({ control }: { control: any }) {
  ...
  const { fields, append, remove } = useFieldArray({ control, name: `securityProof` });
  ...
  return (
    <div>
      <label className="block text-sm font-semibold mb-2">Bukti Foto/Video (STNK, SIM dan NOPOL)</label>
